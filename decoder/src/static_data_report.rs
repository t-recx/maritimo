...
pub fn get(mmsi: u32, bytestring: &str) -> Result<MessageData, NMEADecoderError> {
    ...
    return match part_number {
        ...
        _ => Err(NMEADecoderError {
            error_type: NMEADecoderErrorType::IncorrectPartNumber,
        }),
    };
}
...
fn get_part_b_dimensions(
    bytestring: &str,
    ship_type: u8,
    vendor_id: String,
    call_sign: String,
) -> Result<MessageData, NMEADecoderError> {
